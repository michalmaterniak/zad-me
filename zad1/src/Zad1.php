...
class Zad1
{
    public const int MAX_COUNT = 1000000; // ilosc elementow w tablicy

    public const int NUMBER_MIN = -1000000; // minimalna wartosc elementu
    ...
    public function result(ImplementationInterface $implementation): int
    {
